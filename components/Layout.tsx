      ...
      <nav className="sticky top-0 z-50 border-b border-line-200 bg-white shadow-medium transition-colors duration-300 dark:border-slate-700 dark:bg-slate-900 dark:shadow-none">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 md:h-20 lg:h-24 lg:px-8">
          ...
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <button
              onClick={toggleTheme}
              className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-gray-100 text-ink-900 transition-all duration-200 hover:bg-gray-200 dark:bg-slate-800 dark:text-slate-100 dark:hover:bg-slate-700"
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div>
              ...
              <div className="flex gap-3">
                <a
                  href={firmInfo.socials.facebook}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 text-white transition-all hover:bg-white/20 hover:scale-110"
                  aria-label="Facebook"
                >
                ...
                <a
                  href={firmInfo.socials.linkedin}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 text-white transition-all hover:bg-white/20 hover:scale-110"
                  aria-label="LinkedIn"
